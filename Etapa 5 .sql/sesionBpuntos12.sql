...
UPDATE productos SET precio = precio + 10 WHERE id = 2;

UPDATE productos SET precio = precio + 10 WHERE id = 1;

SELECT precio FROM productos WHERE id < 3;
        ...
        BEGIN
            ...
            BEGIN
                ...
                IF v_error_code IN (1213, 1205) OR v_sqlstate IN ('40001', 'HY000') THEN
                    ...
                    DO SLEEP(v_reintentos); -- Pequeño backoff.
...
SELECT * FROM log_errores ORDER BY id ASC;

SELECT nombre, precio FROM productos WHERE id < 3;

SELECT id, fecha, mensaje FROM log_errores ORDER BY id ASC;
