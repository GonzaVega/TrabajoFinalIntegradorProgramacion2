...
/**
 * Clase principal de la Vista de Consola. Gestiona el bucle del menú principal
 * y delega las acciones a los controladores correspondientes.
 */
public class AppMenu {

    /**
     * Inicia el bucle principal del menú de la aplicación de consola.
     */
    public static void start() {
        ...
        while (!salir) {
            ...
            try {
                ...
                // Captura la excepción de "Máximo de intentos alcanzado" del InputValidator
